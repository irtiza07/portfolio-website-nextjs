...
During March, I signed up for a new <ReferralLink card="amexBusinessGold">American Express Business Gold</ReferralLink> American Express Business Gold through a no-lifetime-langugage (NLL) offer that gives 200,000 Membership Reward (MR) points for $10K spend in 3 months. 
...
The next sign-up-bonus card I signed up for this quarter was the <ReferralLink card="amexAmazonBusinessPrime">AMEX Amazon Business Prime Card</ReferralLink>. It gives me 5% on all Amazon and Whole Foods purchases. 
...
The <ReferralLink card="amexBlueBusinessPlus">AMEX Blue Business Plus (BPP)</ReferralLink> will give me 0% APR for 7 more months. 
...
Finally, one of my favorite card that's always in my wallet - the <ReferralLink card="capitalOneVentureX">Capital One Venture X</ReferralLink>. 
