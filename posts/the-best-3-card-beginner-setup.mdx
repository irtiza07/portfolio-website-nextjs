...
* <ReferralLink card="citiDoubleCash">Citi Double Cash</ReferralLink> (2X unlimited everything)  
* <ReferralLink card="citiCustomCash">Citi Custom Cash</ReferralLink> (5X highest spend ONE category)  
* <ReferralLink card="citiStrataPremier">Citi Strata Premier</ReferralLink> (3X flights, hotels, restaurants, groceries, gas, EV charging)
...
* <ReferralLink card="citiDoubleCash">Citi Double Cash</ReferralLink> \= $0  
* <ReferralLink card="citiCustomCash">Citi Custom Cash</ReferralLink> \= $0  
* <ReferralLink card="citiStrataPremier">Citi Strata Premier</ReferralLink> \= $95
