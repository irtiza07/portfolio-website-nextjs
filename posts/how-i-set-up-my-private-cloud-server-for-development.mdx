...
![server zsh customized](/public/server-zsh-customized.png)
...
![Port Forwarding in VS Code](/public/port-forwarding-vs-code.png)
...
![Portainer Dashboard](/public/portainer-dashboard.png)
