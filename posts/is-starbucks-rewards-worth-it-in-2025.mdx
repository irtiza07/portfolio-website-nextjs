...
* <ReferralLink card="amexGold">American Express Gold</ReferralLink> \- 4% on Dining (9% with stacking)  
* <ReferralLink card="citiCustomCash">Citi Custom Cash</ReferralLink> \- 5% on Dining (10% with stacking)  
* <ReferralLink card="capitalOneSavorRewards">Capital One Savor Rewards</ReferralLink> \- 3% on Dining (8% with stacking) 
