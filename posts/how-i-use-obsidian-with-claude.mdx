...
This is the same trick I used in my [TickTick and Claude setup](/blog/how-i-use-ticktick-with-claude), where a `ticktick-assistant` skill makes Claude default to TickTick for anything task-related.

## One Big Flaw — Privacy Concerns

Similar to [using Claude with TickTick](/blog/how-i-use-ticktick-with-claude) (or any task manager), one of the biggest flaws with this approach is privacy.
