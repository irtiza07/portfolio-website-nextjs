...
1. <ReferralLink card="amexGold">AMEX Gold</ReferralLink>
...
3. <ReferralLink card="amexEverydayPreferred">AMEX Everyday Preferred</ReferralLink>
4. <ReferralLink card="amexBlueBusinessPlus">AMEX Blue Business Plus</ReferralLink>
...
I possess only one Hilton AMEX co-branded credit card — <ReferralLink card="amexHiltonBusiness">Hilton Honors Business Card</ReferralLink>.
...
One of my favorite credit cards of 2023 — and also my only Capital One credit card — has been the <ReferralLink card="capitalOneVentureX">Capital One Venture X</ReferralLink>.
...
With more international travel coming up in 2024, I decided to pull the trigger on another hotel credit card — <ReferralLink card="chaseIHGPremier">Chase's IHG Premier Card</ReferralLink>.
