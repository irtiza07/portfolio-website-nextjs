...
We will start with the easiest no annual fee option \- <ReferralLink card="capitalOneSavorRewards">Capital One Savor Rewards</ReferralLink>.

The card gives 3% on worldwide restaurants and groceries, with no foreign transaction fee. 

If you want to convert 3% cashback into 3X miles, you can pair the card with a <ReferralLink card="capitalOneVentureX">Capital One Venture X</ReferralLink>. 
...
Now, moving from a no annual fee to quite a high annual fee card, let's look at the <ReferralLink card="amexGold">American Express Gold</ReferralLink> card.
...
This is my go to food card, so if you are a foodie like me, <ReferralLink card="amexGold">AMEX Gold</ReferralLink> is my best recommendation.

![](https://ds0fmzhunbzyk.cloudfront.net/credit-cards-photos/bilt.png)

## Bilt Card

Moving back down to no annual fee cards, the <ReferralLink card="biltMastercard">Bilt Card</ReferralLink> is an interesting pick. 
...
If you pull out the <ReferralLink card="biltMastercard">Bilt card</ReferralLink> whenever at a cafe, not only do you get the 3X points, but you can also rest assured that you will hit the 5 transaction requirement. 
...
Staying with the theme of no annual fee cards, the <ReferralLink card="citiCustomCash">Citi Custom Cash</ReferralLink> can be a fantastic option.
...
The card in focus: <ReferralLink card="chaseInkBusinessCash">Chase Ink Business Cash</ReferralLink>.
...
If you live in a big city, most likely <ReferralLink card="amexGold">American Express Gold</ReferralLink> will give the best bang for buck. 

If you frequent Starbucks, <ReferralLink card="citiCustomCash">Citi Custom Cash</ReferralLink> is the low-effort choice and <ReferralLink card="chaseInkBusinessCash">Chase Ink Business Cash</ReferralLink> (with gift cards) is the high-effort option. 

Finally, if you want versatile no annual fee cards, the <ReferralLink card="capitalOneSavorRewards">Capital One Savor Rewards</ReferralLink> and <ReferralLink card="biltMastercard">Bilt Card</ReferralLink> are good options.
